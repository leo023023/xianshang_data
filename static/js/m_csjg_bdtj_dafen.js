...
$(function () {
    ...
    $('.mzku_btn_bg').click(function () {
        if ($(this).val() == $('.name_dafen1114').val()) {
            console.log('到这里来没有？')
            ...
            $(".loader_bg").css({"display": "block",})
            console.log('1114这里来了111');
            // $(".scroller ul .cur").css({"background-color": "#0C1222",})

            console.log('1114这里来了222');
            ...
            $.ajax({
                ...
                success: function (neirog, status) {
                    ...
                    console.log('1114这里来了3333');
                    $('.q_m_pingying').html(neirog.q_m_pingying);
                    console.log('1114这里来了4444');
                    ...
                    console.log('1114这里来了5555');
                    console.log('这个是打分', neirog.q_m_qt_df_qx_lt[1]);

                    $('.q_m_qt_df_qx_lt_1').html(neirog.q_m_qt_df_qx_lt[1]);
                    console.log('1114这里来了66666');
